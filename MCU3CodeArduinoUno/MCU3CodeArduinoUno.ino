...
void loop() 
{
  ...
  errHistM2[0] = (targetValue - newPosition1);
  errHistM3[0] = (targetValue - newPosition1);
  errHistM4[0] = (targetValue - newPosition1);
  ...
  // These gain values have to determined during testing and debugging
  // on the test course.
